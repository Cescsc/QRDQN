# URL https://github.com/Stable-Baselines-Team/stable-baselines3-contrib/blob/master/sb3_contrib/qrdqn/qrdqn.py
...
class QRDQN(OffPolicyAlgorithm):
    ...
    def __init__(
        ...
        buffer_size: int = 100000,  # should be 1e6 according to paper but memory problems alas
